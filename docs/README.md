...
- [FEATURE_ROADMAP.md](FEATURE_ROADMAP.md) - planned work and effort estimates.
- [PROGRESS_TRACKER.md](PROGRESS_TRACKER.md) - current release state and milestones.
- [EXTEND.md](EXTEND.md) - original full-roster expansion brief retained for provenance.
